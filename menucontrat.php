...
<div class="container content">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-body">
                <div class="links">
                    <a href="contrats.php" class="btn btn-primary btn-block mb-2">Consulter les contrats</a>
                    <a href="ajouterContrat.php" class="btn btn-primary btn-block mb-2">Ajouter un contrat</a>
