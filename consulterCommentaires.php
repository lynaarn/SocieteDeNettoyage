...
// Requête principale pour récupérer les commentaires du client
$requete = "SELECT commentaire.CodeC, commentaire.contenu, commentaire.note, commentaire.date_creation 
            FROM commentaire
            WHERE commentaire.client_id = $clientId AND commentaire.contenu LIKE '%$contenu%'";
...
// Requête pour compter le nombre total de commentaires du client
...
<head>
    ...
    <title>Consulter Commentaires - Capiclean</title>
    <!-- Bootstrap CSS -->
...
<div class="container mt-5">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <h2 class="text-center mb-4">Mes Commentaires (<?php echo $nbrCommentaires; ?>)</h2> 
      <form method="get" action="consulterCommentaires.php" class="form-inline mb-3 justify-content-center">
        ...
        <div class="col-md-4">
            <div class="card border-primary shadow rounded">
                ...
                <div class="card-footer">
                    ...
                    <?php } ?>
                    <a href="modifier_commentaire.php?CodeC=<?php echo $commentaire['CodeC']; ?>" class="btn btn-warning">
      ...
      <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center paginationModif">
          <li class="page-item <?php if ($page <= 1) echo 'disabled'; ?>">
            <a class="page-link" href="consulterCommentaires.php?page=<?php echo $page - 1; ?>" tabindex="-1" aria-disabled="true">Précédent</a>
          </li>
          <?php for ($i = 1; $i <= $nbrPage; $i++) { ?>
            <li class="page-item <?php if ($i == $page) echo 'active'; ?>">
              <a class="page-link" href="consulterCommentaires.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
            </li>
          <?php } ?>
          <li class="page-item <?php if ($page >= $nbrPage) echo 'disabled'; ?>">
            <a class="page-link" href="consulterCommentaires.php?page=<?php echo $page + 1; ?>">Suivant</a>
          </li>
        </ul>
      </nav>
    </div>
