...
<div class="container mt-5 custom-container">
    ...
    <label for="codeService" class="form-label">Code Service</label>
    <input type="number" class="form-control form-input" id="codeService" placeholder="Entrez le code du service">
</div>
<div class="form-group">
    <label for="nomService" class="form-label">Nom Service</label>
    <input type="text" class="form-control form-input" id="nomService" placeholder="Entrez le nom du service">
</div>
<div class="form-group">
    <label for="tarif" class="form-label">Tarif (en dinars)</label>
    <input type="number" class="form-control form-input" id="tarif" placeholder="Entrez le tarif" min="0" step="1000">
</div>
<div class="form-group">
    <label for="duree" class="form-label">Durée (en heures)</label>
    <input type="number" class="form-control form-input" id="duree" placeholder="Entrez la durée" min="0" max="24">
</div>
<div class="form-group">
    <label for="description" class="form-label">Description</label>
    <textarea class="form-control form-input" id="description" rows="3" placeholder="Entrez la description"></textarea>
</div>
