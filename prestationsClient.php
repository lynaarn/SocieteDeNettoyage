...
<div class="container content">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-body">
                <div class="links">
                <a href="historiqueprestation.php" class="btn btn-primary btn-block mb-2">Consulter l'historique des préstations </a>
                    <a href="demanderprestation.php" class="btn btn-primary btn-block mb-2">demander une préstation</a>
