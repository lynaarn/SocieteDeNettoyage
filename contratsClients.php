...
<div class="container content">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-body">
                <div class="links">
                <a href="consultercontrat.php" class="btn btn-primary btn-block mb-2">Consulter mon contrat </a>
                    <a href="demandercontrat.php" class="btn btn-primary btn-block mb-2">demander un contrat</a>
