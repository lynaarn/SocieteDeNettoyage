...
if(isset($_SESSION['user'])){
        ...
        try {
            ...
            $sql_users = "INSERT INTO users (nom, prenom, email, telephone, adresse, login, password, etat) VALUES (?, ?, ?, ?, ?, ?, ?, 1)";
            ...
            foreach ($competences as $competence_id) {
                echo "Insertion de la compétence $competence_id pour l'employé $user_id<br>"; // Debug: Afficher chaque insertion de compétence
