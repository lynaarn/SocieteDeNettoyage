...
<div class="container mt-5">
  <div class="row">
    <div class="col">
      <h2 class="center-text">La liste des clients :</h2> 
      <div class="photo1"><img src="images/6.jpg" /></div>
    ...
    <a href="supprimerClients.php" class="delete-icon"><i class="fa fa-trash"></i></a>
    <a href="modifierClients.php" class="edit-icon"><i class="fa fa-pencil-alt"></i></a>
</td>
</tr>
