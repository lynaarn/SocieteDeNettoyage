...
<div class="form-group">
    ...
    <div class="form-group">
                    ...
                    <input type="text" name="Service" class="form-control form-input" id="service" value="">
                </div>
                <div class="form-group">
                    <label for="nombreHeures" class="form-label">Nombre d'Heures:</label>
                    <input type="number" name="NombreHeures" class="form-control form-input" id="nombreHeures" value="" min="0">
                </div>
                <div class="form-group">
                    <label for="frequence" class="form-label">Fréquence:</label>
                    <select name="Frequence" id="frequence" class="form-control form-input">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="Adresse" class="form-control form-input" id="adresse" value="">
                </div>
