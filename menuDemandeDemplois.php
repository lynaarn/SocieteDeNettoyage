...
<div class="container content">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-body">
                <div class="links">
                <a href="demandeDemplois.php" class="btn btn-primary btn-block mb-2">Consulter les demandes d'emplois </a>
                    <a href="ajouterDemandeDemploi.php" class="btn btn-primary btn-block mb-2">Poster une nouvelle demande d'emplois</a>
