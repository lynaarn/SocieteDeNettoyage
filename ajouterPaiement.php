  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent"> 
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="paiement.php">Paiements</a>
        </li>
        <li class="nav-item">
...
<div class="container mt-5 custom-container">
    ...
    <div class="photo4"><img src="images/17.jpg" /></div>
        <div class="col-md-6">
       
            <h2 class="text-center mb-4 center-text2 ">Ajouter un paiement</h2>
           
            <form>
            <div class="form-group">
    <label for="codeService" class="form-label">Code paiement</label>
...
<div class="form-group">
                    ...
                    <input type="date" class="form-control form-input" id="datePaiement">
                </div>
